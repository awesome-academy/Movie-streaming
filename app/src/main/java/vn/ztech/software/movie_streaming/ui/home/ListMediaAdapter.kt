...
class ListMediaAdapter(private val listener: (Media) -> Unit)
    : BaseAdapter<
        Media,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MediaViewHolder {
        val view = LayoutMovieItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return MediaViewHolder(view, listener)
    }

    class MediaViewHolder(private val binding: LayoutMovieItemBinding, private val listener: (Media) -> Unit): BaseViewHolder<Media, LayoutMovieItemBinding>(binding){
